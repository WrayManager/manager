...
namespace WHMCS\Module\Addon\Wray\Client;
...
class Controller
{
    ...
    public function index($vars)
    {
        ...
        $modulelink = $vars['modulelink']; // eg. addonmodules.php?module=wray
        ...
        return array(
            ...
            'breadcrumb' => array(
                'index.php?m=wray' => 'Sample Addon Module',
            ),
    ...
    public function secret($vars)
    {
        ...
        return array(
            ...
            'breadcrumb' => array(
                'index.php?m=wray' => 'Sample Addon Module',
                'index.php?m=wray&action=secret' => 'Secret Page',
            ),
